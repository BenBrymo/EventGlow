...
val supabaseFunctionsCloudinaryDeletePath =
    (project.findProperty("SUPABASE_FUNCTIONS_CLOUDINARY_DELETE_PATH") as? String)?.trim().orEmpty()
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField(
            "String",
            "SUPABASE_FUNCTIONS_CLOUDINARY_DELETE_PATH",
            supabaseFunctionsCloudinaryDeletePath.toBuildConfigString()
        )
